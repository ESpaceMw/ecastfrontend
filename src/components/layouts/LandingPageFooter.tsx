    ...
    return(
        <footer className="text-gray-600 body-font bg-gray-50">
            <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                ...
                <p className="mt-2 text-sm text-gray-500">The world is listening,<br />Say something...</p>
                </div>
            ...
            <div className="bg-gray-100">
                ...
                <p className="text-gray-500 text-sm text-center sm:text-left">© {new Date().getFullYear()} E-Cast — All rights reserved
                </p>
