    ...
    <div className="min-h-screen px-5 flex items-center justify-center bg-gray-50 dark:bg-gray-900">
        <div className="max-w-md w-full mb-10">
          <div>
            ...
            <button 
            type="button" 
            onClick={() => openInNewTab('http://127.0.0.1:8000/api/v1/auth/redirect')}
            className="w-full mt-4 block bg-white dark:bg-gray-900 hover:bg-gray-100 focus:bg-gray-100 dark:text-gray-300 text-gray-900 font-semibold rounded-none p-3 border border-gray-300 dark:border-gray-700">
