    ...
    return(
        <div className="dark:bg-gray-900">
          ...
          <section className="body-font">
            <div className="container mx-auto flex py-5 sm:px-24 px-5  md:flex-row flex-col items-center">
          ...
          <section className="text-gray-600 body-font">
            <div className="container mx-auto flex py-10 sm:px-24 px-5  md:flex-row flex-col items-center">
              <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
          ...
          <section className="text-gray-600 body-font bg-gray-50 dark:bg-gray-800">
            <div className="container mx-auto flex py-10 sm:px-24 px-5  md:flex-row flex-col items-center">
              ...
              <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                ...
                <div className="flex justify-center">
                  <button className="inline-flex mb-4 sm:mb-0 text-white bg-blue-400 border-0 py-2 px-6 focus:outline-none hover:bg-blue-500 rounded-sm text-md">Read more...</button>
                </div>
              </div>
          ...
          <section className="text-gray-600 body-font bg-gray-50 dark:bg-gray-800">
            <div className="container sm:px-24 px-5  py-5 mx-auto">
              ...
              <div className="flex lg:w-2/3 w-full sm:flex-row flex-col mx-auto px-8 sm:space-x-4 sm:space-y-0 space-y-4 sm:px-0 items-end">
                ...
                <button className="w-full sm:w-64 text-white bg-blue-500 border-0 py-2 px-8 focus:outline-none hover:bg-blue-600 rounded-sm text-md">Subscribe</button>
              </div>
            </div>
          </section>
          ...
          <section className="text-gray-600 body-font">
            <div className="container px-5 sm:py-24 py-5 mx-auto flex items-center md:flex-row flex-col">
              ...
              <div className="sm:flex md:ml-auto md:mr-0 mx-auto items-center sm:flex-shrink-0 sm:space-x-4 space-y-2">
                <button className="sm:w-64 w-full mr-2 bg-gray-100 dark:bg-gray-800 inline-flex py-3 px-5 rounded-sm items-center hover:bg-gray-200 focus:outline-none">
                ...
                <button className="sm:w-64 w-full bg-gray-100 dark:bg-gray-800 inline-flex py-3 px-5 rounded-sm items-center hover:bg-gray-200 focus:outline-none">
