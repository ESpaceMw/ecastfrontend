        ...
        <div>
          ...
          <section className="text-gray-600 body-font">
            <div className="container mx-auto flex py-5 px-24 md:flex-row flex-col items-center">
              ...
              <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                <h1 className="title-font sm:text-4xl text-3xl mb-4 font-semibold text-gray-900">Share and touch more lives. We've got everything it takes to help you live a more meaningful life
                </h1>
                <p className="mb-8 leading-relaxed">Your ministry, movement or desire to transform the world is all possible. Your voice can make a difference, so why shouldn't we help you reach out to the world more?</p>
                <div className="flex justify-center">
          ...
          <section className="text-gray-600 body-font bg-gray-50">
            <div className="container px-24 py-10 mx-auto">
              <h3 className="text-3xl font-semibold text-center mb-5">The world is listening, Say something...</h3>
              <div className="flex flex-wrap -m-4">
                <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                  <div className="h-full text-center">
                    ...
                    <p className="leading-relaxed">Podcasting has helped me know more about my customer,  and it's no longer about how much I've gained in profit... it's about them, and it makes the whole difference because it's no longer just a business, we are serving!</p>
                    <span className="inline-block h-1 w-10 rounded bg-blue-500 mt-6 mb-4"></span>
                    <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase">Chikumbutso Thomas</h2>
                    <p className="text-gray-500">CEO @ Hype Productions</p>
                  </div>
                </div>
                <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                  <div className="h-full text-center">
          ...
          <section className="text-gray-600 body-font">
            <div className="container mx-auto flex py-10 px-24 md:flex-row flex-col items-center">
              ...
              <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                <h1 className="title-font sm:text-4xl text-3xl mb-4 font-semibold text-gray-900">You too your podcast can be on the world's biggest streaming services!
                </h1>
                <p className="mb-8 leading-relaxed">Record a podcast today and we will help you get it on Spotify, Apple podcasts, Google podcasts and many other major podcast distributors to reach out to millions of more people worldwide!</p>
                <div className="flex justify-center">
          ...
          <section className="text-gray-600 body-font bg-gray-50">
            <div className="container mx-auto flex py-10 px-24 md:flex-row flex-col items-center">
              ...
              <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                <h1 className="title-font sm:text-4xl text-3xl mb-4 font-semibold text-gray-900">Earn Revenue with eCast as you host your podcast with us 
                </h1>
                <p className="mb-8 leading-relaxed">Every podcaster does it for the love of their craft, but love don't put food on the table! We get it, and that's why we've got a way to make you earn some cheddar!</p>
                <div className="flex justify-center">
                  <button className="inline-flex text-white bg-blue-400 border-0 py-2 px-6 focus:outline-none hover:bg-blue-500 rounded-sm text-md">Read more...</button>
                </div>
              </div>
          ...
          <section className="text-gray-600 body-font bg-gray-50">
            <div className="container px-24 py-5 mx-auto">
              <div className="flex flex-col text-center w-full mb-12">
                <h1 className="sm:text-3xl text-2xl font-semibold title-font mb-4 text-gray-900">Subscribe to eCast Newsletters</h1>
                <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Get daily updates on new podcast releases, trends and many more from eCast right into your mail inbox.</p>
              </div>
              <div className="flex lg:w-2/3 w-full sm:flex-row flex-col mx-auto px-8 sm:space-x-4 sm:space-y-0 space-y-4 sm:px-0 items-end">
          
                <div className="relative flex-grow w-full">
                  <label htmlFor="email" className="leading-7 text-sm text-gray-600">Email address</label>
                  <input type="email" id="email" name="email" className="w-full bg-gray-50 bg-opacity-50 rounded-sm border border-gray-300 focus:border-blue-500 focus:bg-transparent focus:ring-2 focus:ring-blue-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"/>
                </div>
          ...
          <section className="text-gray-600 body-font">
            <div className="container px-5 py-24 mx-auto flex items-center md:flex-row flex-col">
              <div className="flex flex-col md:pr-10 md:mb-0 mb-6 pr-0 w-full md:w-auto md:text-left text-center">
                <h2 className="text-xs text-blue-300 tracking-widest font-semibold title-font mb-1">GET THE MOBILE APP</h2>
                <h1 className="md:text-3xl text-2xl font-semibold title-font text-gray-900">Download eCast App</h1>
              </div>
              <div className="flex md:ml-auto md:mr-0 mx-auto items-center flex-shrink-0 space-x-4">
                <button className="bg-gray-100 inline-flex py-3 px-5 rounded-sm items-center hover:bg-gray-200 focus:outline-none">
