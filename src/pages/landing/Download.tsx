...
const Download = () => {
    return(
      <div>
        <div className="bg-cover bg-center absolute z-0 h-screen bg-no-repeat" style={{backgroundImage: `url('http://preview.uxtheme.website/xpider-preview/xpider/img/hero-8.png')` }}></div>
            <div className="z-0 opacity-90 w-full h-full absolute" style={{background: `linear-gradient(-45deg, #2f1ce0 0%, #53a0fd 50%, #51eca5 100%)`}}></div>
            <div className="absolute w-full flex flex-col">
                <div className="bg-bottom bg-no-repeat bg-cover" style={{backgroundImage: `url('https://galaxy.up.video/media/backgrounds/bg-curve.svg')`}}>
                        ...
                        <div className="container mx-auto flex flex-wrap mt-8 mb-8 ">
                            <div className="flex sm:w-1/2">
                                <svg version="1.1" id="isologo" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                    width="40px" height="40px" viewBox="0 0 399.998 399.997"
                                    xmlSpace="preserve">
                    ...
                    <section className="w-full">
                        <div className="container mx-auto flex flex-row sm:items-center xl:pb-16 xl:px-0 px-4">
                            <div className="w-1/2 text-white flex flex-col">
                                <h1 className="sm:text-5xl text-xl font-weight-bolder sm:mb-4">Best app landin page for Apps Downloads.</h1>
                                <h2 className="sm:text-2xl text-base mb-2">Tailwind landing app theme.</h2>
                                <p className="text-xs sm:text-base">This is your text under h1 and h2. Write your main text promotional here.</p>
                                <form className="xl:mt-4 mt-8 flex hidden xl:flex">
                                    <input className="rounded-l-full p-4 border-t mr-0 border-b border-l text-gray-800 border-gray-200 bg-white" placeholder="your@mail.com"/>
                                    <button className="px-8 rounded-r-full bg-yellow-400  text-gray-800 font-bold p-4 uppercase border-yellow-500 border-t border-b border-r">Subscribe</button>
                                </form>
                                <p className="text-xs sm:block hidden">* Legal text</p>
                            </div>
                            <div className="w-1/2 xl:pt-8 xl:items-center flex justify-end">
                                <img className="xl:w-3/5" src="http://preview.uxtheme.website/xpider-preview/xpider/img/mobile-4.png" alt="Mobile phone"/>
                            </div>
                        </div>
                    </section>
                </div>
          ...
          <section className="text-gray-600 body-font">
            <div className="container py-5 px-24 mx-auto">
                <div className="flex flex-col text-center w-full mb-20">
                <h1 className="sm:text-3xl text-2xl font-semibold title-font mb-4 text-gray-900">The best hosting site</h1>
